...
namespace SimpleApi.Controllers
{
    ...
    public class GuestsController : ControllerBase
    {
        ...
        {
            new GuestModel { Id = 1, FirstName = "Adam", LastName = "Sherwood" },
            new GuestModel { Id = 2, FirstName = "David", LastName = "Smith" },
            new GuestModel { Id = 3, FirstName = "Robert", LastName = "Carpenter" }
        };
